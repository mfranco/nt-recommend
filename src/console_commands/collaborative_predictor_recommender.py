...
from app.analytics.recommenders import CollaborativePredictorRecommenderRunner
...
def run(**kwargs):
    """
    KFold experiment for CollaborativePredictorRecommenderRunner
    """
    ...
    runner = CollaborativePredictorRecommenderRunner(
    ...
    t.add_row([
        'CollaborativePredictorRecommender',
    ...
    fname = os.path.join(
        app.config['DATA_DIR'], 'results', 'CollaborativePredictorRecommender_{}.txt'.format(
