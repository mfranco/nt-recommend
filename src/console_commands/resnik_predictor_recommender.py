...
from app.analytics.recommenders import ResnikPredictorRecommenderRunner
...
def run(**kwargs):
    """
    KFold experiment for ResnikPredictorRecommenderRunner
    """
    ...
    runner = ResnikPredictorRecommenderRunner(
    ...
    fname = os.path.join(
        app.config['DATA_DIR'], 'results', 'ResnikPredictorRecommender_{}.txt'.format(
