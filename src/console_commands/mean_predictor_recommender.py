...
from app.analytics.recommenders import MeanPredictorRecommenderRunner
...
def run(**kwargs):
    """
    KFold experiment for MeanPredictorRecommenderRunner
    """
    ...
    runner = MeanPredictorRecommenderRunner(
