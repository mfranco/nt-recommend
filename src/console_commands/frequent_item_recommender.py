...
from app.analytics.recommenders import FrequentItemRecommenderRunner
...
def run(**kwargs):
    """
    KFold experiment for FrequentItemRecommenderRunner
    """
    ...
    runner = FrequentItemRecommenderRunner(
    ...
    fname = os.path.join(
        app.config['DATA_DIR'], 'results', 'FrequentItemRecommender_{}.txt'.format(
